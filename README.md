...
**[최신 버전 0.8.0 내려받기](https://github.com/woosshe/TokTok-releases/releases/latest)** — `TokTok-0.8.0-Setup.exe`
...
- **알림(리마인더)** — 메모마다 알림 시각을 걸어 두면 그 시각에 Windows 알림으로 알려줍니다.
  10분 후 / 1시간 후 / 오늘 저녁 / 내일 아침 프리셋과 직접 지정이 있고, 알림을 클릭하면 그 메모가
  화면에 뜹니다(닫아 둔 메모도 함께). 알림 시각은 기기 간에 공유됩니다.
